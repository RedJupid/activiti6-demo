describe('Array', function() {
    ...
    describe('indexOf', function() {
        ...
        it('should use a strict common', function() {
        ...
        describe('Array-like', function ArrayLike() {
            ...
            it('should use a strict common (array-like)', function() {
    ...
    describe('splice', function () {
        ...
        it('basic implementation common 1', function () {
            expect(test.splice(0)).toEqual(a);
        });
        it('basic implementation common 2', function () {
            test.splice(0, 2);
