...
public class FlowUtils {
    ...
    public InputStream getResourceDiagramInputStream(String id) {
        try {
            ...
            InputStream imageStream = processDiagramGenerator.generateDiagram(bpmnModel, "png", executedActivityIdList, flowIds, "宋体", "微软雅黑", "黑体", processEngineConfiguration.getClassLoader(),1.0);
            return imageStream;
        } catch (Exception e) {
            e.printStackTrace();
            return null;
